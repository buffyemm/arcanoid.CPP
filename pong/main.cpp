...
void InitGame()
{
    ...
    hBack = (HBITMAP)LoadImageA(NULL, "back.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);//testgfgfgdfgdgdggdgdgdggdgfgfgfgfgfdfdfsdfsdfsdfsdfsdfsfsdfsdf
    //------------------------------------------------------
    // trtertwtwetwetwetgwetwetgwrfgsdffgsdfgsdfgsdfgdfwsdfsffds
